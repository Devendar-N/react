import { Star,Return, Delivery } from "@images/images";
    ...
    <div className="product-colour">
      <div className="product-available-colours">
        ...
        <div className="product-change-colour">
          <button className="product-colour-blue"></button>
          <button className="product-colour-red"></button>
        </div>
      </div>
      <div className="purchase-details">
        <div className="product-quantity-container">
          <IoRemove size={14} className="quantity-minus" />
          <div className="quantity-display" id="product-quantity-display">
            0
          </div>
          <IoAdd size={14} className="quantity-plus" />
        </div>
